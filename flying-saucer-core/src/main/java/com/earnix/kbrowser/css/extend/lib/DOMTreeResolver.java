 ...
 *
 */
package com.earnix.kbrowser.css.extend.lib;
...
public class DOMTreeResolver implements TreeResolver {
    public Object getParentElement(Object element) {
        com.earnix.kbrowser.dom.nodes.Node parent = ((com.earnix.kbrowser.dom.nodes.Element) element).parentNode();
        if (!(parent instanceof com.earnix.kbrowser.dom.nodes.Element)) parent = null;
        return parent;
    }

    public Object getPreviousSiblingElement(Object element) {
        com.earnix.kbrowser.dom.nodes.Node sibling = ((com.earnix.kbrowser.dom.nodes.Element) element).previousSibling();
        while (sibling != null && !(sibling instanceof com.earnix.kbrowser.dom.nodes.Element)) {
