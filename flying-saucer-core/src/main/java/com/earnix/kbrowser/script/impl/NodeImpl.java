...
import com.earnix.kbrowser.script.whatwg_dom.impl.EventImpl;
...
public class NodeImpl implements Node {
    ...
    com.earnix.kbrowser.dom.nodes.Node target;
    BasicPanel panel;

    public NodeImpl(com.earnix.kbrowser.dom.nodes.Node target, BasicPanel panel) {
        this.target = target;
        this.panel = panel;
    }
