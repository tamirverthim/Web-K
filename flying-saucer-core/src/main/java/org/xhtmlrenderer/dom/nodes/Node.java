...
public abstract class Node implements Cloneable {
     ...
     * @see org.xhtmlrenderer.dom.nodes.Element#elementSiblingIndex()
     */
    ...
    public Node setScriptNode(NodeImpl scriptNode) {
