package org.xhtmlrenderer.dom.select;
...
import org.xhtmlrenderer.dom.nodes.DocumentType;
import org.xhtmlrenderer.dom.nodes.Element;
import org.xhtmlrenderer.dom.nodes.Node;
import org.xhtmlrenderer.dom.nodes.PseudoTextElement;
import org.xhtmlrenderer.dom.nodes.TextNode;
import org.xhtmlrenderer.dom.nodes.XmlDeclaration;

import java.util.List;
import java.util.regex.Matcher;
import java.util.regex.Pattern;

import static org.xhtmlrenderer.dom.internal.Normalizer.lowerCase;
...
public abstract class Evaluator {
    ...
    public static final class AttributeStarting extends Evaluator {
        ...
        @Override
        public boolean matches(Element root, Element element) {
            List<org.xhtmlrenderer.dom.nodes.Attribute> values = element.attributes().asList();
            for (org.xhtmlrenderer.dom.nodes.Attribute attribute : values) {
        ...
        public boolean matches(Element root, Element element) {
            ...
            for (TextNode textNode : textNodes) {
                PseudoTextElement pel = new PseudoTextElement(
                    org.xhtmlrenderer.dom.parser.Tag.valueOf(element.tagName()), element.baseUri(), element.attributes());
