...
public class DelegatingReplacedElementFactory implements ReplacedElementFactory {
    ...
    public void remove(final com.earnix.kbrowser.dom.nodes.Element element) {
    ...
    private static class ERItem {
        private final com.earnix.kbrowser.dom.nodes.Element element;
        private final ReplacedElement replacedElement;
        private final ElementReplacer elementReplacer;

        private ERItem(final com.earnix.kbrowser.dom.nodes.Element e, final ReplacedElement re, final ElementReplacer er) {
            element = e;
            replacedElement = re;
            elementReplacer = er;
        }
