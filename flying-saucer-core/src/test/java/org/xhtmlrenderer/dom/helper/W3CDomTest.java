...
import org.xhtmlrenderer.dom.TextUtil;
import org.xhtmlrenderer.dom.integration.ParseTest;
...
public class W3CDomTest {
    ...
    public void simpleConversion() {
        ...
        org.xhtmlrenderer.dom.nodes.Document doc = Jsoup.parse(html);
    ...
    public void convertsGoogle() throws IOException {
        ...
        org.xhtmlrenderer.dom.nodes.Document doc = Jsoup.parse(in, "UTF8");
    ...
    public void namespacePreservation() throws IOException {
        ...
        org.xhtmlrenderer.dom.nodes.Document jsoupDoc;
        jsoupDoc = Jsoup.parse(in, "UTF-8");

        Document doc;
        org.xhtmlrenderer.dom.helper.W3CDom jDom = new org.xhtmlrenderer.dom.helper.W3CDom();
