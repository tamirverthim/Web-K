package org.xhtmlrenderer.dom.integration;

import org.xhtmlrenderer.dom.Connection;
import org.xhtmlrenderer.dom.HttpStatusException;
import org.xhtmlrenderer.dom.Jsoup;
import org.xhtmlrenderer.dom.UnsupportedMimeTypeException;
import org.xhtmlrenderer.dom.internal.StringUtil;
import org.xhtmlrenderer.dom.helper.W3CDom;
import org.xhtmlrenderer.dom.nodes.Document;
import org.xhtmlrenderer.dom.nodes.FormElement;
import org.xhtmlrenderer.dom.parser.HtmlTreeBuilder;
import org.xhtmlrenderer.dom.parser.Parser;
import org.xhtmlrenderer.dom.parser.XmlTreeBuilder;
...
public class UrlConnectTest {
    ...
    public void exceptOnUnknownContentType() {
        ...
        try {
            ...
            threw = true;
            assertEquals("org.xhtmlrenderer.dom.UnsupportedMimeTypeException: Unhandled content type. Must be text/*, application/xml, or application/xhtml+xml. Mimetype=image/png, URL=http://direct.jsoup.org/rez/osi_logo.png", e.toString());
    ...
    public void throwsExceptionOnError() {
        ...
        try {
            ...
            threw = true;
            assertEquals("org.xhtmlrenderer.dom.HttpStatusException: HTTP error fetching URL. Status=404, URL=http://direct.infohound.net/tools/404", e.toString());
            assertEquals(url, e.getUrl());
