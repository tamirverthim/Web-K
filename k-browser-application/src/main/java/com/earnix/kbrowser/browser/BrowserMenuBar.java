...
import com.earnix.kbrowser.browser.actions.ZoomAction;
import com.earnix.kbrowser.swing.BasicPanel;
import com.earnix.kbrowser.swing.DOMInspector;
...
class BrowserMenuBar extends JMenuBar {
    ...
    BrowserMenuBar(KBrowserApplication root) {
        this.root = root;
    }
