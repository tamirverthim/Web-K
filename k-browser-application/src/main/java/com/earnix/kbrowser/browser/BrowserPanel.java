...
import com.earnix.kbrowser.swing.ImageResourceLoader;
import com.earnix.kbrowser.swing.ScalableXHTMLPanel;
...
public class BrowserPanel extends JPanel implements DocumentListener {
    ...
    KBrowserApplication browserApplication;
    ...
    BrowserPanel(KBrowserApplication root, BrowserPanelListener listener) {
        super();
