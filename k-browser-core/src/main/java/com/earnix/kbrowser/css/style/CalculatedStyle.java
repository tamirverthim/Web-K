...
import com.earnix.kbrowser.css.style.derived.FunctionValue;
import com.earnix.kbrowser.css.style.derived.LengthValue;
import com.earnix.kbrowser.css.style.derived.ListValue;
import com.earnix.kbrowser.css.style.derived.NumberValue;
 ...
 * com.earnix.kbrowser.layout.Context} be given to it, for some cases of property
 * resolution. Generally, a programmer will not use this class directly, but
 * will retrieve properties using a {@link com.earnix.kbrowser.context.StyleReference}
 * implementation.
 *
