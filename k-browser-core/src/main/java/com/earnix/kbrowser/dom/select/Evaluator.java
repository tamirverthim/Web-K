package com.earnix.kbrowser.dom.select;
...
import com.earnix.kbrowser.dom.nodes.PseudoTextElement;
import com.earnix.kbrowser.dom.nodes.TextNode;
import com.earnix.kbrowser.dom.nodes.XmlDeclaration;

import java.util.List;
import java.util.regex.Matcher;
import java.util.regex.Pattern;

import static com.earnix.kbrowser.dom.internal.Normalizer.lowerCase;
...
public abstract class Evaluator {
    ...
    public static final class AttributeStarting extends Evaluator {
        ...
        @Override
        public boolean matches(Element root, Element element) {
            List<com.earnix.kbrowser.dom.nodes.Attribute> values = element.attributes().asList();
            for (com.earnix.kbrowser.dom.nodes.Attribute attribute : values) {
        ...
        public boolean matches(Element root, Element element) {
            ...
            for (TextNode textNode : textNodes) {
                PseudoTextElement pel = new PseudoTextElement(
                        com.earnix.kbrowser.dom.parser.Tag.valueOf(element.tagName()), element.baseUri(), element.attributes());
