 ...
 *
 */
package com.earnix.kbrowser.extend;

import com.earnix.kbrowser.dom.nodes.Document;
import com.earnix.kbrowser.resource.CSSResource;
import com.earnix.kbrowser.resource.ImageResource;
import com.earnix.kbrowser.swing.BasicPanel;
import com.earnix.kbrowser.swing.NaiveUserAgent;
 ...
 * own UserAgentCallback when constructing an {@link com.earnix.kbrowser.simple.XHTMLPanel}
 * or {@link BasicPanel}.</p>
 *
 ...
 * implemetations shipped with the library, like the {@link NaiveUserAgent}.
 * </p>
 *
...
public interface UserAgentCallback {
     ...
     */
    Document getXMLResource(String uri);
