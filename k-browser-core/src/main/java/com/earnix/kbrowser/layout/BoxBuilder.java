...
import com.earnix.kbrowser.css.constants.MarginBoxName;
import com.earnix.kbrowser.css.constants.PageElementPosition;
import com.earnix.kbrowser.css.extend.ContentFunction;
...
import com.earnix.kbrowser.css.style.EmptyStyle;
...
import com.earnix.kbrowser.newtable.TableBox;
import com.earnix.kbrowser.newtable.TableCellBox;
import com.earnix.kbrowser.newtable.TableColumn;
import com.earnix.kbrowser.newtable.TableRowBox;
import com.earnix.kbrowser.newtable.TableSectionBox;
import com.earnix.kbrowser.render.AnonymousBlockBox;
import com.earnix.kbrowser.render.BlockBox;
import com.earnix.kbrowser.render.Box;
import com.earnix.kbrowser.render.FloatedBoxData;
import com.earnix.kbrowser.render.InlineBox;
...
public class BoxBuilder {
    ...
    public static BlockBox createRootBox(LayoutContext c, com.earnix.kbrowser.dom.nodes.Document document) {
        Element root = document.child(0); // "html" element
    ...
    private static void addColumns(LayoutContext c, TableBox table, TableColumn parent) {
        ...
        Node working = parent.getElement().childNodeSize() > 0 ? parent.getElement().childNode(0) : null;
        boolean found = false;
        while (working != null) {
    ...
    private static void createChildren(
        ...
        Node working = parent.childNodeSize() > 0 ? parent.childNode(0) : null;
...
//                short nodeType = working.getNodeType();
                if (working instanceof Element) {
                    ...
                    */
                    ...
                    child = createInlineBox(textNode.getWholeText(), parent, parentStyle, textNode);
