...
import com.earnix.kbrowser.script.html5.canvas.impl.CanvasGradientImpl;
import com.earnix.kbrowser.script.html5.canvas.impl.CanvasPatternImpl;
...
public class ScriptContext implements DocumentListener {
    ...
    private void initEngine() {
        ...
        context.setAttribute("document", WebIDLAdapter.obtain(this, new com.earnix.kbrowser.script.html5.impl.DocumentImpl(panel)), ENGINE_SCOPE);
