...
//import com.earnix.kbrowser.script.impl.DOMStringImpl;
//import com.earnix.kbrowser.script.impl.USVStringImpl;
...
//        }
        ...
        if (res.getClass().getPackage().getName().startsWith("com.earnix.kbrowser.script")) {
    ...
    private Object[] prepareArguments(Method method, Object[] rawArgs) {
        ...
        for (int i = 0; i < result.length; i++) {
            ...
            if (rawArgs.length < i + 1) {
                ...
                if (!hasAnnotation(parameter, com.earnix.kbrowser.script.web_idl.Optional.class)) {
                ...
                if (rawArg != null) {
                    ...
                    if (hasAnnotation(parameter, TreatNullAs.class) && parameter.getAnnotation(TreatNullAs.class).value() == NullTreat.EmptyString) {
                        ...
                        if (!hasAnnotation(parameter, Nullable.class) && hasAnnotation(parameter, com.earnix.kbrowser.script.web_idl.Optional.class)) {
