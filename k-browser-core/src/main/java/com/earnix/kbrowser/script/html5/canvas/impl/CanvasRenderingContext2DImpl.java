...
import com.earnix.kbrowser.css.parser.CSSParser;
...
import com.earnix.kbrowser.script.html5.canvas.CanvasDirection;
import com.earnix.kbrowser.script.html5.canvas.CanvasFillRule;
import com.earnix.kbrowser.script.html5.canvas.CanvasGradient;
import com.earnix.kbrowser.script.html5.canvas.CanvasImageSource;
...
import com.earnix.kbrowser.script.html5.canvas.CanvasPattern;
import com.earnix.kbrowser.script.html5.canvas.CanvasRenderingContext2D;
...
import com.earnix.kbrowser.script.html5.canvas.ImageData;
import com.earnix.kbrowser.script.html5.canvas.ImageSmoothingQuality;
import com.earnix.kbrowser.script.html5.canvas.TextMetrics;
import com.earnix.kbrowser.script.impl.TextMetricsImpl;
...
public class CanvasRenderingContext2DImpl implements CanvasRenderingContext2D {
    ...
    @Override
    public void clip(com.earnix.kbrowser.script.html5.canvas.Path2D path, CanvasFillRule fillRule) {
        log.trace("clip");
    }
    ...
    @Override
    public boolean isPointInPath(com.earnix.kbrowser.script.html5.canvas.Path2D path, double x, double y, CanvasFillRule fillRule) {
        log.trace("isPointInPath");
        return false;
    }
    ...
    @Override
    public boolean isPointInStroke(com.earnix.kbrowser.script.html5.canvas.Path2D path, double x, double y) {
        log.trace("isPointInStroke");
        return false;
    }
    ...
    @Override
    public void drawFocusIfNeeded(com.earnix.kbrowser.script.html5.canvas.Path2D path, Element element) {
        log.trace("drawFocusIfNeeded");
    }
    ...
    @Override
    public void scrollPathIntoView(com.earnix.kbrowser.script.html5.canvas.Path2D path) {
        log.trace("scrollPathIntoView");
    }
