...
import com.earnix.kbrowser.script.cssom_view.ScrollToOptions;
...
import com.earnix.kbrowser.script.whatwg_dom.DOMTokenList;
import com.earnix.kbrowser.script.whatwg_dom.DOMTokenListImpl;
...
import com.earnix.kbrowser.script.whatwg_dom.ShadowRoot;
import com.earnix.kbrowser.script.whatwg_dom.ShadowRootInit;
import com.earnix.kbrowser.script.whatwg_dom.css_style_attribute.CSSStyleAttribute;
import com.earnix.kbrowser.script.whatwg_dom.impl.HTMLCollectionImpl;
import com.earnix.kbrowser.script.whatwg_dom.impl.NamedNodeMapImpl;
...
public class ElementImpl extends NodeImpl implements HTMLElement {
    ...
    final com.earnix.kbrowser.dom.nodes.Element model;
    final ChildNodeImpl childNodeMixin;
    final BasicPanel panel;

    public ElementImpl(com.earnix.kbrowser.dom.nodes.Element model, BasicPanel panel) {
        super(model, panel);
        this.model = model;
        this.panel = panel;
    ...
    public com.earnix.kbrowser.dom.nodes.Element getModel() {
        return model;
    }
