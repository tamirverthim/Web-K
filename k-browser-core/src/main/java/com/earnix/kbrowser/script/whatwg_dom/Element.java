...
import com.earnix.kbrowser.script.web_idl.PutForwards;
 ...
 * 6/20/2018
 */
public interface Element extends Node, ParentNode, NonDocumentTypeChildNode, ChildNode, Slotable, com.earnix.kbrowser.script.cssom_view.Element {
