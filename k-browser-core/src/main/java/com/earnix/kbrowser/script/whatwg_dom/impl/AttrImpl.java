...
import com.earnix.kbrowser.script.whatwg_dom.EventListener;
import com.earnix.kbrowser.script.whatwg_dom.GetRootNodeOptions;
...
public class AttrImpl implements Attr {
    ...
    @Override
    public com.earnix.kbrowser.script.web_idl.Attribute<String> value() {
        return new com.earnix.kbrowser.script.web_idl.Attribute<String>() {
            @Override
            public String get() {
    ...
    @Override
    public com.earnix.kbrowser.script.whatwg_dom.Element ownerElement() {
    ...
    @Override
    public com.earnix.kbrowser.script.whatwg_dom.Element parentElement() {
    ...
    @Override
    public com.earnix.kbrowser.script.web_idl.Attribute<String> nodeValue() {
        return new com.earnix.kbrowser.script.web_idl.Attribute<String>() {
            @Override
            public String get() {
                return model.getValue();
    ...
    @Override
    public com.earnix.kbrowser.script.web_idl.Attribute<String> textContent() {
        return nodeValue();
    }
