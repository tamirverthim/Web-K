...
import com.earnix.kbrowser.simple.extend.DefaultFormSubmissionListener;
import com.earnix.kbrowser.simple.extend.FormSubmissionListener;
import com.earnix.kbrowser.simple.extend.XhtmlForm;
import com.earnix.kbrowser.simple.extend.form.FormField;
...
public class SwingReplacedElementFactory implements ReplacedElementFactory {
    ...
    private ReplacedElement createReplacedElementImpl(
        ...
        if (context.getNamespaceHandler().isImageElement(e)) {
            ...
            HTMLCanvasElementImpl canvasElement = (HTMLCanvasElementImpl) Binder.get(e, ((BasicPanel) context.getSharedContext().getCanvas()));
