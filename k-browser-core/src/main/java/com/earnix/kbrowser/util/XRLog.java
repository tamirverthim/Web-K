...
public class XRLog {
    ...
    public static final String CONFIG = registerLoggerByName("com.earnix.kbrowser.config");
    public static final String EXCEPTION = registerLoggerByName("com.earnix.kbrowser.exception");
    public static final String GENERAL = registerLoggerByName("com.earnix.kbrowser.general");
    public static final String INIT = registerLoggerByName("com.earnix.kbrowser.init");
    public static final String JUNIT = registerLoggerByName("com.earnix.kbrowser.junit");
    public static final String LOAD = registerLoggerByName("com.earnix.kbrowser.load");
    public static final String MATCH = registerLoggerByName("com.earnix.kbrowser.match");
    public static final String CASCADE = registerLoggerByName("com.earnix.kbrowser.cascade");
    public static final String XML_ENTITIES = registerLoggerByName("com.earnix.kbrowser.load.xml-entities");
    public static final String CSS_PARSE = registerLoggerByName("com.earnix.kbrowser.css-parse");
    public static final String LAYOUT = registerLoggerByName("com.earnix.kbrowser.layout");
    public static final String RENDER = registerLoggerByName("com.earnix.kbrowser.render");
