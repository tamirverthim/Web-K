...
import com.earnix.kbrowser.dom.TextUtil;
import com.earnix.kbrowser.dom.integration.ParseTest;
...
public class W3CDomTest {
    ...
    public void simpleConversion() {
        ...
        com.earnix.kbrowser.dom.nodes.Document doc = Jsoup.parse(html);
    ...
    public void convertsGoogle() throws IOException {
        ...
        com.earnix.kbrowser.dom.nodes.Document doc = Jsoup.parse(in, "UTF8");
    ...
    public void namespacePreservation() throws IOException {
        ...
        com.earnix.kbrowser.dom.nodes.Document jsoupDoc;
        jsoupDoc = Jsoup.parse(in, "UTF-8");

        Document doc;
        com.earnix.kbrowser.dom.helper.W3CDom jDom = new com.earnix.kbrowser.dom.helper.W3CDom();
