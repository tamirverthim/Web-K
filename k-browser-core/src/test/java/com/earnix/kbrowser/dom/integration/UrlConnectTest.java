package com.earnix.kbrowser.dom.integration;

import com.earnix.kbrowser.dom.Connection;
import com.earnix.kbrowser.dom.HttpStatusException;
import com.earnix.kbrowser.dom.Jsoup;
import com.earnix.kbrowser.dom.UnsupportedMimeTypeException;
import com.earnix.kbrowser.dom.helper.W3CDom;
import com.earnix.kbrowser.dom.internal.StringUtil;
import com.earnix.kbrowser.dom.nodes.Document;
import com.earnix.kbrowser.dom.nodes.FormElement;
import com.earnix.kbrowser.dom.parser.HtmlTreeBuilder;
import com.earnix.kbrowser.dom.parser.Parser;
import com.earnix.kbrowser.dom.parser.XmlTreeBuilder;
...
public class UrlConnectTest {
    ...
    public void exceptOnUnknownContentType() {
        ...
        try {
            ...
            threw = true;
            assertEquals("com.earnix.kbrowser.dom.UnsupportedMimeTypeException: Unhandled content type. Must be text/*, application/xml, or application/xhtml+xml. Mimetype=image/png, URL=http://direct.jsoup.org/rez/osi_logo.png", e.toString());
    ...
    public void throwsExceptionOnError() {
        ...
        try {
            ...
            threw = true;
            assertEquals("com.earnix.kbrowser.dom.HttpStatusException: HTTP error fetching URL. Status=404, URL=http://direct.infohound.net/tools/404", e.toString());
            assertEquals(url, e.getUrl());
