...
import com.earnix.kbrowser.swing.AWTFSImage;
import com.earnix.kbrowser.swing.EmptyReplacedElement;
import com.earnix.kbrowser.swing.ImageReplacedElement;
...
public class SwingImageReplacer extends ElementReplacer {
    ...
    public boolean accept(final LayoutContext context, final com.earnix.kbrowser.dom.nodes.Element element) {
    ...
    public void clear(com.earnix.kbrowser.dom.nodes.Element element) {
     ...
     */
    protected ReplacedElement replaceImage(UserAgentCallback uac, LayoutContext context, com.earnix.kbrowser.dom.nodes.Element elem, int cssWidth, int cssHeight) {
     ...
     */
    protected void storeImageReplacedElement(com.earnix.kbrowser.dom.nodes.Element e, ReplacedElement cc) {
     ...
     */
    protected ReplacedElement lookupImageReplacedElement(com.earnix.kbrowser.dom.nodes.Element e) {
