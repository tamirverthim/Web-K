...
import com.earnix.webk.css.style.derived.FunctionValue;
import com.earnix.webk.css.style.derived.LengthValue;
import com.earnix.webk.css.style.derived.ListValue;
import com.earnix.webk.css.style.derived.NumberValue;
 ...
 * com.earnix.webk.layout.Context} be given to it, for some cases of property
 * resolution. Generally, a programmer will not use this class directly, but
 * will retrieve properties using a {@link com.earnix.webk.context.StyleReference}
 * implementation.
 *
