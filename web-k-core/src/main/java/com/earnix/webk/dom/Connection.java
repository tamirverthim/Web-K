 ...
 * <p>
 * To get a new Connection, use {@link com.earnix.webk.dom.Jsoup#connect(String)}. Connections contain {@link Connection.Request}
...
public interface Connection {
     ...
     * @return this Connection, for chaining
     * @see com.earnix.webk.dom.helper.HttpConnection#DEFAULT_UA
     */
     ...
     * @return this Connection, for chaining
     * @see com.earnix.webk.dom.Connection.Request#headers()
     */
     ...
     */
    DocumentImpl get() throws IOException;
     ...
     * @throws IOException                     on error
     */
    DocumentImpl post() throws IOException;
    ...
    interface Response extends Base<Response> {
         ...
         * @throws IOException on error
         */
        DocumentImpl parse() throws IOException;
