 ...
 * }}}
 */
package com.earnix.webk.log4j;

import com.earnix.webk.util.XRLog;
import com.earnix.webk.util.XRLogger;
...
public class Log4JXRLogger implements XRLogger {
    ...
    private static final String DEFAULT_LOGGER_NAME = "com.earnix.webk.other";
    ...
    static {
        ...
        LOGGER_NAME_MAP.put(XRLog.CONFIG, "com.earnix.webk.config");
        LOGGER_NAME_MAP.put(XRLog.EXCEPTION, "com.earnix.webk.exception");
        LOGGER_NAME_MAP.put(XRLog.GENERAL, "com.earnix.webk.general");
        LOGGER_NAME_MAP.put(XRLog.INIT, "com.earnix.webk.init");
        LOGGER_NAME_MAP.put(XRLog.JUNIT, "com.earnix.webk.junit");
        LOGGER_NAME_MAP.put(XRLog.LOAD, "com.earnix.webk.load");
        LOGGER_NAME_MAP.put(XRLog.MATCH, "com.earnix.webk.match");
        LOGGER_NAME_MAP.put(XRLog.CASCADE, "com.earnix.webk.cascade");
        LOGGER_NAME_MAP.put(XRLog.XML_ENTITIES, "com.earnix.webk.load.xmlentities");
        LOGGER_NAME_MAP.put(XRLog.CSS_PARSE, "com.earnix.webk.cssparse");
        LOGGER_NAME_MAP.put(XRLog.LAYOUT, "com.earnix.webk.layout");
        LOGGER_NAME_MAP.put(XRLog.RENDER, "com.earnix.webk.render");
    }
