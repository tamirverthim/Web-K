...
import com.earnix.webk.runtime.dom.impl.select.NodeFilter;
...
import com.earnix.webk.runtime.dom.GetRootNodeOptions;
...
public abstract class NodeImpl implements Node, Cloneable {
    ...
    @Override
    public com.earnix.webk.runtime.dom.Element parentElement() {
...
//    }
     ...
     * and the {@code "Two "} {@link com.earnix.webk.runtime.dom.impl.TextImpl} being returned.
     *
