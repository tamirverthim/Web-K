...
/**
 * Represents a {@link com.earnix.webk.runtime.dom.impl.TextImpl} as an {@link ElementImpl}, to enable text nodes to be selected with
 * the {@link com.earnix.webk.runtime.dom.impl.select.Selector} {@code :matchText} syntax.
 */
