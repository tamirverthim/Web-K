...
import com.earnix.webk.runtime.html.canvas.CanvasDirection;
import com.earnix.webk.runtime.html.canvas.CanvasFillRule;
import com.earnix.webk.runtime.html.canvas.CanvasGradient;
import com.earnix.webk.runtime.html.canvas.CanvasImageSource;
import com.earnix.webk.runtime.html.canvas.CanvasLineCap;
import com.earnix.webk.runtime.html.canvas.CanvasLineJoin;
import com.earnix.webk.runtime.html.canvas.CanvasPattern;
import com.earnix.webk.runtime.html.canvas.CanvasRenderingContext2D;
import com.earnix.webk.runtime.html.canvas.CanvasTextAlign;
import com.earnix.webk.runtime.html.canvas.CanvasTextBaseline;
...
public class CanvasRenderingContext2DImpl implements CanvasRenderingContext2D {
    ...
    @Override
    public void clip(com.earnix.webk.runtime.html.canvas.Path2D path, CanvasFillRule fillRule) {
        log.trace("clip");
    }
    ...
    @Override
    public boolean isPointInPath(com.earnix.webk.runtime.html.canvas.Path2D path, double x, double y, CanvasFillRule fillRule) {
        log.trace("isPointInPath");
        return false;
    }
    ...
    @Override
    public boolean isPointInStroke(com.earnix.webk.runtime.html.canvas.Path2D path, double x, double y) {
        log.trace("isPointInStroke");
        return false;
    }
    ...
    @Override
    public void drawFocusIfNeeded(com.earnix.webk.runtime.html.canvas.Path2D path, Element element) {
        log.trace("drawFocusIfNeeded");
    }
    ...
    @Override
    public void scrollPathIntoView(com.earnix.webk.runtime.html.canvas.Path2D path) {
        log.trace("scrollPathIntoView");
    }
