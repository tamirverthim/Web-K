package com.earnix.webk.runtime.whatwg_dom.impl.examples;
...
public class HtmlToPlainText {
    ...
    public static void main(String... args) throws IOException {
        ...
        DocumentImpl doc = Jsoup.connect(url).userAgent(userAgent).timeout(timeout).get();
     ...
     */
    public String getPlainText(ElementImpl element) {
    ...
    private class FormattingVisitor implements NodeVisitor {
        ...
        public void head(NodeImpl node, int depth) {
            ...
            if (node instanceof TextImpl) {
                append(((TextImpl) node).getWholeText()); // TextNodes carry all user-readable text in the DOM.
