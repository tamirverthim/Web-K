...
import static com.earnix.webk.runtime.whatwg_dom.impl.internal.Normalizer.normalize;
    ...
    public static final class MatchText extends Evaluator {
        ...
        public boolean matches(ElementImpl root, ElementImpl element) {
            ...
            for (TextImpl textNode : textNodes) {
                PseudoTextElement pel = new PseudoTextElement(com.earnix.webk.runtime.whatwg_dom.impl.parser.Tag.valueOf(element.tagName()), element.baseUri(), element.getAttributes());
