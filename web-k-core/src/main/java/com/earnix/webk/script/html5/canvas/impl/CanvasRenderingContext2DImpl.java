package com.earnix.webk.script.html5.canvas.impl;
...
import com.earnix.webk.script.html5.canvas.CanvasDirection;
import com.earnix.webk.script.html5.canvas.CanvasFillRule;
import com.earnix.webk.script.html5.canvas.CanvasGradient;
import com.earnix.webk.script.html5.canvas.CanvasImageSource;
import com.earnix.webk.script.html5.canvas.CanvasLineCap;
import com.earnix.webk.script.html5.canvas.CanvasLineJoin;
import com.earnix.webk.script.html5.canvas.CanvasPattern;
import com.earnix.webk.script.html5.canvas.CanvasRenderingContext2D;
import com.earnix.webk.script.html5.canvas.CanvasTextAlign;
import com.earnix.webk.script.html5.canvas.CanvasTextBaseline;
import com.earnix.webk.script.html5.canvas.HTMLCanvasElement;
import com.earnix.webk.script.html5.canvas.ImageData;
import com.earnix.webk.script.html5.canvas.ImageSmoothingQuality;
...
public class CanvasRenderingContext2DImpl implements CanvasRenderingContext2D {
    ...
    @Override
    public void clip(com.earnix.webk.script.html5.canvas.Path2D path, CanvasFillRule fillRule) {
        log.trace("clip");
    }
    ...
    @Override
    public boolean isPointInPath(com.earnix.webk.script.html5.canvas.Path2D path, double x, double y, CanvasFillRule fillRule) {
        log.trace("isPointInPath");
        return false;
    }
    ...
    @Override
    public boolean isPointInStroke(com.earnix.webk.script.html5.canvas.Path2D path, double x, double y) {
        log.trace("isPointInStroke");
        return false;
    }
    ...
    @Override
    public void drawFocusIfNeeded(com.earnix.webk.script.html5.canvas.Path2D path, Element element) {
        log.trace("drawFocusIfNeeded");
    }
    ...
    @Override
    public void scrollPathIntoView(com.earnix.webk.script.html5.canvas.Path2D path) {
        log.trace("scrollPathIntoView");
    }
