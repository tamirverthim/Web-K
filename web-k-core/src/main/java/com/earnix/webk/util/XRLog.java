...
public class XRLog {
    ...
    public static final String CONFIG = registerLoggerByName("com.earnix.webk.config");
    public static final String EXCEPTION = registerLoggerByName("com.earnix.webk.exception");
    public static final String GENERAL = registerLoggerByName("com.earnix.webk.general");
    public static final String INIT = registerLoggerByName("com.earnix.webk.init");
    public static final String JUNIT = registerLoggerByName("com.earnix.webk.junit");
    public static final String LOAD = registerLoggerByName("com.earnix.webk.load");
    public static final String MATCH = registerLoggerByName("com.earnix.webk.match");
    public static final String CASCADE = registerLoggerByName("com.earnix.webk.cascade");
    public static final String XML_ENTITIES = registerLoggerByName("com.earnix.webk.load.xml-entities");
