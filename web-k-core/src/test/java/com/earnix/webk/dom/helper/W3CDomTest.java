...
public class W3CDomTest {
    ...
    public void simpleConversion() {
        ...
        com.earnix.webk.dom.nodes.Document doc = Jsoup.parse(html);
    ...
    public void convertsGoogle() throws IOException {
        ...
        com.earnix.webk.dom.nodes.Document doc = Jsoup.parse(in, "UTF8");
    ...
    public void namespacePreservation() throws IOException {
        ...
        com.earnix.webk.dom.nodes.Document jsoupDoc;
        jsoupDoc = Jsoup.parse(in, "UTF-8");

        Document doc;
        com.earnix.webk.dom.helper.W3CDom jDom = new com.earnix.webk.dom.helper.W3CDom();
