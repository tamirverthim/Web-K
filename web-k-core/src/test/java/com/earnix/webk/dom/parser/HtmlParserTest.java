...
public class HtmlParserTest {
    ...
    public void parsesSimpleDocument() {
        ...
        ElementModel p = doc.body().child(0);
        assertEquals("p", p.tagName());
        ElementModel img = p.child(0);
    ...
    public void dropsUnterminatedTag() {
        ...
        String h1 = "<p";
        DocumentModel doc = Jsoup.parse(h1);
    ...
    public void parsesUnterminatedTextarea() {
        ...
        DocumentModel doc = Jsoup.parse("<body><p><textarea>one<p>two");
        ElementModel t = doc.select("textarea").first();
    ...
    public void parsesUnterminatedOption() {
        ...
        DocumentModel doc = Jsoup.parse("<body><p><select><option>One<option>Two</p><p>Three</p>");
    ...
    public void testSelectWithOption() {
        ...
        DocumentModel document = parser.parseInput("<select><option>Option 1</option></select>", "http://jsoup.org");
        assertEquals(0, parser.getErrors().size());
    }

    @Test
    public void testSpaceAfterTag() {
        DocumentModel doc = Jsoup.parse("<div > <a name=\"top\"></a ><p id=1 >Hello</p></div>");
    ...
    public void handlesEscapedData() {
        ...
        DocumentModel doc = Jsoup.parse(html);
        ElementModel div = doc.getElementsByTag("div").get(0);
    ...
    public void handlesTextArea() {
        DocumentModel doc = Jsoup.parse("<textarea>Hello</textarea>");
    ...
    public void preservesSpaceInTextArea() {
        ...
        DocumentModel doc = Jsoup.parse("<textarea>\n\tOne\n\tTwo\n\tThree\n</textarea>");
        String expect = "One\n\tTwo\n\tThree"; // the leading and trailing spaces are dropped as a convenience to authors
        ElementModel el = doc.select("textarea").first();
    ...
    public void preservesSpaceInScript() {
        ...
        DocumentModel doc = Jsoup.parse("<script>\nOne\n\tTwo\n\tThree\n</script>");
        String expect = "\nOne\n\tTwo\n\tThree\n";
        ElementModel el = doc.select("script").first();
    ...
    public void doesNotCreateImplicitLists() {
        ...
        DocumentModel doc2 = Jsoup.parse(h2);
    ...
    public void handlesNestedImplicitTable() {
        DocumentModel doc = Jsoup.parse("<table><td>1</td></tr> <td>2</td></tr> <td> <table><td>3</td> <td>4</td></table> <tr><td>5</table>");
    ...
    public void handlesTbodyTable() {
        DocumentModel doc = Jsoup.parse("<html><head></head><body><table><tbody><tr><td>aaa</td><td>bbb</td></tr></tbody></table></body></html>");
    ...
    public void handlesImplicitCaptionClose() {
        DocumentModel doc = Jsoup.parse("<table><caption>A caption<td>One<td>Two");
    ...
    public void noTableDirectInTable() {
        DocumentModel doc = Jsoup.parse("<table> <td>One <td><table><td>Two</table> <table><td>Three");
    ...
    public void ignoresDupeEndTrTag() {
        DocumentModel doc = Jsoup.parse("<table><tr><td>One</td><td><table><tr><td>Two</td></tr></tr></table></td><td>Three</td></tr></table>"); // two </tr></tr>, must ignore or will close table
    ...
    public void handlesBaseTags() {
        ...
        DocumentModel doc = Jsoup.parse(h, "http://foo/");
    ...
    public void handlesProtocolRelativeUrl() {
        ...
        DocumentModel doc = Jsoup.parse(html, base);
        ElementModel el = doc.select("img").first();
    ...
    public void handlesCdataInScript() {
        ...
        String data = "//<![CDATA[\n\n  foo();\n//]]>";
        ElementModel script = doc.selectFirst("script");
    ...
    public void handlesUnknownInlineTags() {
        ...
        DocumentModel doc = Jsoup.parseBodyFragment(h);
    ...
    public void parsesBodyFragment() {
        ...
        DocumentModel doc = Jsoup.parseBodyFragment(h, "http://example.com");
    ...
    public void handlesBaseWithoutHref() {
        ...
        DocumentModel doc = Jsoup.parse(h, "http://example.com/");
        ElementModel a = doc.select("a").first();
    ...
    public void normalisesHeadlessBody() {
        DocumentModel doc = Jsoup.parse("<html><body><span class=\"foo\">bar</span>");
    ...
    public void normalisedBodyAfterContent() {
        DocumentModel doc = Jsoup.parse("<font face=Arial><body class=name><div>One</div></body></font>");
    ...
    public void testHgroup() {
        ...
        DocumentModel doc = Jsoup.parse("<h1>Hello <h2>There <hgroup><h1>Another<h2>headline</hgroup> <hgroup><h1>More</h1><p>stuff</p></hgroup>");
    ...
    public void testRelaxedTags() {
        DocumentModel doc = Jsoup.parse("<abc_def id=1>Hello</abc_def> <abc-def>There</abc-def>");
    ...
    public void testHeaderContents() {
        ...
        DocumentModel doc = Jsoup.parse("<h1>Hello <div>There</div> now</h1> <h2>More <h3>Content</h3></h2>");
    ...
    public void testSpanContents() {
        ...
        DocumentModel doc = Jsoup.parse("<span>Hello <div>there</div> <span>now</span></span>");
    ...
    public void testNoImagesInNoScriptInHead() {
        ...
        DocumentModel doc = Jsoup.parse("<html><head><noscript><img src='foo'></noscript></head><body><p>Hello</p></body></html>");
    ...
    public void testAFlowContents() {
        ...
        DocumentModel doc = Jsoup.parse("<a>Hello <div>there</div> <span>now</span></a>");
    ...
    public void testFontFlowContents() {
        ...
        DocumentModel doc = Jsoup.parse("<font>Hello <div>there</div> <span>now</span></font>");
    ...
    public void handlesUnclosedTitle() {
        DocumentModel one = Jsoup.parse("<title>One <b>Two <b>Three</TITLE><p>Test</p>"); // has title, so <b> is plain text
        assertEquals("One <b>Two <b>Three", one.title());
        assertEquals("Test", one.select("p").first().text());

        DocumentModel two = Jsoup.parse("<title>One<b>Two <p>Test</p>"); // no title, so <b> causes </title> breakout
    ...
    public void handlesNewlinesAndWhitespaceInTag() {
        DocumentModel doc = Jsoup.parse("<a \n href=\"one\" \r\n id=\"two\" \f >");
    ...
    public void tracksErrorsWhenRequested() {
        ...
        DocumentModel doc = Jsoup.parse(html, "http://example.com", parser);
    ...
    public void tracksLimitedErrorsWhenRequested() {
        ...
        DocumentModel doc = parser.parseInput(html, "http://example.com");
    ...
    public void handlesCommentsInTable() {
        ...
        DocumentModel node = Jsoup.parseBodyFragment(html);
    ...
    public void handleNullContextInParseFragment() {
        ...
        List<NodeModel> nodes = Parser.parseFragment(html, null, "http://example.com/");
    ...
    public void createsFormElements() {
        ...
        DocumentModel doc = Jsoup.parse(html);
        ElementModel el = doc.select("form").first();
    ...
    public void handlesInvalidDoctypes() {
        ...
        DocumentModel doc = Jsoup.parse("<!DOCTYPE>");
        assertEquals(
    ...
    public void handlesManyChildren() {
        ...
        DocumentModel doc = Parser.parseBodyFragment(longBody.toString(), "");
    ...
    public void testNormalisesIsIndex() {
        DocumentModel doc = Jsoup.parse("<body><isindex action='/submit'></body>");
    ...
    public void testFragment() {
        ...
        DocumentModel body = Jsoup.parseBodyFragment(html);
    ...
    public void testHtmlLowerCase() {
        ...
        ElementModel div = doc.selectFirst("#1");
    ...
    public void canPreserveTagCase() {
        ...
        DocumentModel doc = parser.parseInput("<div id=1><SPAN ID=2>", "");
    ...
    public void handlesControlCodeInAttributeName() {
        DocumentModel doc = Jsoup.parse("<p><a \06=foo>One</a><a/\06=bar><a foo\06=bar>Two</a></p>");
    ...
    public void caseSensitiveParseTree() {
        ...
        DocumentModel doc = parser.parseInput(html, "");
    ...
    public void normalizesDiscordantTags() {
        DocumentModel document = Jsoup.parse("<div>test</DIV><p></p>");
    ...
    public void testTemplateInsideTable() throws IOException {
        ...
        for (ElementModel template : templates) {
    ...
    public void testHandlesDeepSpans() {
        ...
        DocumentModel doc = Jsoup.parse(sb.toString());
    ...
    public void preSkipsFirstNewline() {
        DocumentModel doc = Jsoup.parse("<pre>\n\nOne\nTwo\n</pre>");
        ElementModel pre = doc.selectFirst("pre");
        assertEquals("One\nTwo", pre.text());
        assertEquals("\nOne\nTwo\n", pre.wholeText());
    }
    ...
    public void fallbackToUtfIfCantEncode() throws IOException {
        ...
        DocumentModel doc = Jsoup.parse(new ByteArrayInputStream(in.getBytes()), null, "");
