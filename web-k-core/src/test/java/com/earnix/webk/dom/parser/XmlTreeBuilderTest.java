...
public class XmlTreeBuilderTest {
    ...
    public void xmlParseDefaultsToHtmlOutputSyntax() {
        ...
        assertEquals(com.earnix.webk.script.whatwg_dom.impl.DocumentImpl.OutputSettings.Syntax.xml, doc.outputSettings().syntax());
    }
    ...
    public void testCreatesValidProlog() {
        ...
        document.outputSettings().syntax(com.earnix.webk.script.whatwg_dom.impl.DocumentImpl.OutputSettings.Syntax.xml);
