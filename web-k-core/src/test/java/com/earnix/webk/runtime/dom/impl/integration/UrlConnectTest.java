package com.earnix.webk.runtime.dom.impl.integration;

import com.earnix.webk.runtime.dom.impl.Connection;
import com.earnix.webk.runtime.dom.impl.HttpStatusException;
import com.earnix.webk.runtime.dom.impl.Jsoup;
import com.earnix.webk.runtime.dom.impl.UnsupportedMimeTypeException;
import com.earnix.webk.runtime.dom.impl.helper.W3CDom;
import com.earnix.webk.runtime.dom.impl.internal.StringUtil;
import com.earnix.webk.runtime.dom.impl.nodes.FormElement;
import com.earnix.webk.runtime.dom.impl.parser.HtmlTreeBuilder;
import com.earnix.webk.runtime.dom.impl.parser.Parser;
import com.earnix.webk.runtime.dom.impl.parser.XmlTreeBuilder;
...
public class UrlConnectTest {
    ...
    public void exceptOnUnknownContentType() {
        ...
        boolean threw = false;
        try {
            DocumentImpl doc = Jsoup.parse(new URL(url), 3000);
    ...
    public void followsTempRedirect() throws IOException {
        ...
        assertTrue(doc.getTitle().contains("jsoup"));
    }
    ...
    public void followsRedirectToHttps() throws IOException {
        ...
        con.data("id", "5");
        DocumentImpl doc = con.get();
        assertTrue(doc.getTitle().contains("Google"));
    }
    ...
    public void followsRelativeRedirect() throws IOException {
        ...
        assertTrue(doc.getTitle().contains("HTML Tidy Online"));
    }
    ...
    public void maximumRedirects() {
        boolean threw = false;
        try {
            DocumentImpl doc = Jsoup.connect("http://direct.infohound.net/tools/loop.pl").get();
        } catch (IOException e) {
    ...
    public void handlesDodgyCharset() throws IOException {
        ...
        DocumentImpl doc = res.parse(); // would throw an error if charset unsupported
    ...
    public void postHtmlFile() throws IOException {
        DocumentImpl index = Jsoup.connect("http://direct.infohound.net/tidy/").get();
    ...
    public void sendHeadRequest() throws IOException {
        ...
        DocumentImpl doc = response.parse();
    ...
    public void fetchViaHttpProxy() throws IOException {
        ...
        DocumentImpl doc = Jsoup.connect(url).proxy(proxy).get();
        assertTrue(doc.getTitle().contains("jsoup"));
    }
    ...
    public void fetchViaHttpProxySetByArgument() throws IOException {
        String url = "https://jsoup.org";
        DocumentImpl doc = Jsoup.connect(url).proxy("localhost", 8888).get();
        assertTrue(doc.getTitle().contains("jsoup"));
    }
    ...
    public void invalidProxyFails() throws IOException {
        ...
        String url = "https://jsoup.org";
        try {
            DocumentImpl doc = Jsoup.connect(url).proxy("localhost", 8889).get();
        } catch (IOException e) {
    ...
    public void proxyGetAndSet() throws IOException {
        ...
        DocumentImpl doc = con.get();
        assertTrue(doc.getTitle().contains("jsoup")); // would fail if actually went via proxy
    }
    ...
    public void throwsIfRequestBodyForGet() throws IOException {
        ...
        String url = "https://jsoup.org";
        try {
            DocumentImpl doc = Jsoup.connect(url).requestBody("fail").get();
    ...
    public void canSpecifyResponseCharset() throws IOException {
        ...
        final DocumentImpl doc1 = res1.parse();
        assertEquals("windows-1252", doc1.getCharset().displayName()); // but determined at parse time
        ...
        final DocumentImpl doc2 = res2.parse();
        assertEquals("UTF-8", doc2.getCharset().displayName()); // so defaults to utf-8
        ...
        final DocumentImpl doc3 = res3.parse();
        assertEquals("windows-1252", doc3.getCharset().displayName()); // from override
