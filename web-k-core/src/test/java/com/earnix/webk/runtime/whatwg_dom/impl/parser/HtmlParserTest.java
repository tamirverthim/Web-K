...
import com.earnix.webk.runtime.whatwg_dom.impl.integration.ParseTest;
...
import com.earnix.webk.runtime.whatwg_dom.impl.nodes.Entities;
import com.earnix.webk.runtime.whatwg_dom.impl.nodes.FormElement;
import com.earnix.webk.runtime.whatwg_dom.impl.safety.Whitelist;
...
public class HtmlParserTest {
    ...
    public void parsesSimpleDocument() {
        ...
        ElementImpl p = doc.getBody().child(0);
        assertEquals("p", p.tagName());
        ElementImpl img = p.child(0);
    ...
    public void parsesQuiteRoughAttributes() {
        ...
        // assertEquals("<p =a>One<a <p>Something</a></p>\n<a <p>Else</a>", doc.getBody().html());

        Assert.assertEquals("<p =a>One<a></a></p><p><a>Something</a></p><a>Else</a>", TextUtil.stripNewlines(doc.getBody().html()));

        doc = Jsoup.parse("<p .....>");
        assertEquals("<p .....></p>", doc.getBody().html());
    }
    ...
    public void parsesComments() {
        ...
        CommentImpl comment = (CommentImpl) body.childNode(1); // comment should not be sub of img, as it's an empty tag
    ...
    public void parsesUnterminatedComments() {
        ...
        DocumentImpl doc = Jsoup.parse(html);
        ElementImpl p = doc.getElementsByTag("p").get(0);
        assertEquals("Hello", p.text());
        TextImpl text = (TextImpl) p.childNode(0);
        assertEquals("Hello", text.getWholeText());
        CommentImpl comment = (CommentImpl) p.childNode(1);
    ...
    public void dropsUnterminatedTag() {
        ...
        String h1 = "<p";
        DocumentImpl doc = Jsoup.parse(h1);
    ...
    public void parsesUnterminatedTextarea() {
        ...
        DocumentImpl doc = Jsoup.parse("<body><p><textarea>one<p>two");
        ElementImpl t = doc.select("textarea").first();
    ...
    public void parsesUnterminatedOption() {
        ...
        DocumentImpl doc = Jsoup.parse("<body><p><select><option>One<option>Two</p><p>Three</p>");
    ...
    public void testSelectWithOption() {
        ...
        DocumentImpl document = parser.parseInput("<select><option>Option 1</option></select>", "http://jsoup.org");
        assertEquals(0, parser.getErrors().size());
    }

    @Test
    public void testSpaceAfterTag() {
        DocumentImpl doc = Jsoup.parse("<div > <a name=\"top\"></a ><p id=1 >Hello</p></div>");
        assertEquals("<div> <a name=\"top\"></a><p id=\"1\">Hello</p></div>", TextUtil.stripNewlines(doc.getBody().html()));
    }
    ...
    public void createsDocumentStructure() {
        ...
        DocumentImpl doc = Jsoup.parse(html);
        ElementImpl head = doc.getHead();
        ElementImpl body = doc.getBody();

        assertEquals(1, doc.getChildren().size()); // root node: contains html node
        assertEquals(2, doc.child(0).getChildren().size()); // html node: head and body
        assertEquals(3, head.getChildren().size());
    ...
    public void handlesEscapedData() {
        ...
        DocumentImpl doc = Jsoup.parse(html);
        ElementImpl div = doc.getElementsByTag("div").get(0);
    ...
    public void handlesTextArea() {
        DocumentImpl doc = Jsoup.parse("<textarea>Hello</textarea>");
    ...
    public void preservesSpaceInTextArea() {
        ...
        DocumentImpl doc = Jsoup.parse("<textarea>\n\tOne\n\tTwo\n\tThree\n</textarea>");
        String expect = "One\n\tTwo\n\tThree"; // the leading and trailing spaces are dropped as a convenience to authors
        ElementImpl el = doc.select("textarea").first();
    ...
    public void preservesSpaceInScript() {
        ...
        DocumentImpl doc = Jsoup.parse("<script>\nOne\n\tTwo\n\tThree\n</script>");
        String expect = "\nOne\n\tTwo\n\tThree\n";
        ElementImpl el = doc.select("script").first();
    ...
    public void doesNotCreateImplicitLists() {
        ...
        DocumentImpl doc2 = Jsoup.parse(h2);
        ...
        assertEquals(1, doc2.select("ol li").get(0).getChildren().size()); // one p in first li
    }
    ...
    public void discardsNakedTds() {
        ...
        DocumentImpl doc = Jsoup.parse(h);
        assertEquals("Hello<p>There</p><p>now</p>", TextUtil.stripNewlines(doc.getBody().html()));
    ...
    public void handlesNestedImplicitTable() {
        DocumentImpl doc = Jsoup.parse("<table><td>1</td></tr> <td>2</td></tr> <td> <table><td>3</td> <td>4</td></table> <tr><td>5</table>");
        assertEquals("<table><tbody><tr><td>1</td></tr> <tr><td>2</td></tr> <tr><td> <table><tbody><tr><td>3</td> <td>4</td></tr></tbody></table> </td></tr><tr><td>5</td></tr></tbody></table>", TextUtil.stripNewlines(doc.getBody().html()));
    }
    ...
    public void handlesWhatWgExpensesTableExample() {
        ...
        assertEquals("<table> <colgroup> <col> </colgroup><colgroup> <col> <col> <col> </colgroup><thead> <tr> <th> </th><th>2008 </th><th>2007 </th><th>2006 </th></tr></thead><tbody> <tr> <th scope=\"rowgroup\"> Research and development </th><td> $ 1,109 </td><td> $ 782 </td><td> $ 712 </td></tr><tr> <th scope=\"row\"> Percentage of net sales </th><td> 3.4% </td><td> 3.3% </td><td> 3.7% </td></tr></tbody><tbody> <tr> <th scope=\"rowgroup\"> Selling, general, and administrative </th><td> $ 3,761 </td><td> $ 2,963 </td><td> $ 2,433 </td></tr><tr> <th scope=\"row\"> Percentage of net sales </th><td> 11.6% </td><td> 12.3% </td><td> 12.6% </td></tr></tbody></table>", TextUtil.stripNewlines(doc.getBody().html()));
    }

    @Test
    public void handlesTbodyTable() {
        DocumentImpl doc = Jsoup.parse("<html><head></head><body><table><tbody><tr><td>aaa</td><td>bbb</td></tr></tbody></table></body></html>");
        assertEquals("<table><tbody><tr><td>aaa</td><td>bbb</td></tr></tbody></table>", TextUtil.stripNewlines(doc.getBody().html()));
    }

    @Test
    public void handlesImplicitCaptionClose() {
        DocumentImpl doc = Jsoup.parse("<table><caption>A caption<td>One<td>Two");
        assertEquals("<table><caption>A caption</caption><tbody><tr><td>One</td><td>Two</td></tr></tbody></table>", TextUtil.stripNewlines(doc.getBody().html()));
    }

    @Test
    public void noTableDirectInTable() {
        DocumentImpl doc = Jsoup.parse("<table> <td>One <td><table><td>Two</table> <table><td>Three");
    ...
    public void ignoresDupeEndTrTag() {
        DocumentImpl doc = Jsoup.parse("<table><tr><td>One</td><td><table><tr><td>Two</td></tr></tr></table></td><td>Three</td></tr></table>"); // two </tr></tr>, must ignore or will close table
    ...
    public void handlesBaseTags() {
        ...
        DocumentImpl doc = Jsoup.parse(h, "http://foo/");
    ...
    public void handlesProtocolRelativeUrl() {
        ...
        DocumentImpl doc = Jsoup.parse(html, base);
        ElementImpl el = doc.select("img").first();
    ...
    public void handlesCdataAcrossBuffer() {
        ...
        DocumentImpl doc = Jsoup.parse(h);
        ElementImpl div = doc.selectFirst("div");

        CDATASectionImpl node = (CDATASectionImpl) div.textNodes().get(0);
    ...
    public void handlesCdataInScript() {
        ...
        String data = "//<![CDATA[\n\n  foo();\n//]]>";
        ElementImpl script = doc.selectFirst("script");
        ...
        DataImpl dataNode = (DataImpl) script.childNode(0);
    ...
    public void handlesUnclosedCdataAtEOF() {
        ...
        String h = "<![CDATA[]]";
        DocumentImpl doc = Jsoup.parse(h);
        assertEquals(1, doc.getBody().childNodeSize());
    }
    ...
    public void handleCDataInText() {
        ...
        List<NodeImpl> nodes = p.getChildNodes();
        assertEquals("One ", ((TextImpl) nodes.get(0)).getWholeText());
        assertEquals("Two <&", ((TextImpl) nodes.get(1)).getWholeText());
        assertEquals("Two <&", ((CDATASectionImpl) nodes.get(1)).getWholeText());
        assertEquals(" Three", ((TextImpl) nodes.get(2)).getWholeText());
    ...
    public void cdataNodesAreTextNodes() {
        ...
        List<TextImpl> nodes = p.textNodes();
    ...
    public void handlesUnknownInlineTags() {
        ...
        DocumentImpl doc = Jsoup.parseBodyFragment(h);
        String out = doc.getBody().html();
    ...
    public void parsesBodyFragment() {
        ...
        DocumentImpl doc = Jsoup.parseBodyFragment(h, "http://example.com");
        assertEquals("<body><!-- comment --><p><a href=\"foo\">One</a></p></body>", TextUtil.stripNewlines(doc.getBody().outerHtml()));
    ...
    public void handlesUnknownNamespaceTags() {
        ...
        DocumentImpl doc = Jsoup.parse(h);
        assertEquals("<foo:bar id=\"1\" /><abc:def id=\"2\">Foo<p>Hello</p></abc:def><foo:bar>There</foo:bar>", TextUtil.stripNewlines(doc.getBody().html()));
    }
    ...
    public void handlesKnownEmptyBlocks() {
        ...
        DocumentImpl doc = Jsoup.parse(h);
        assertEquals("<div id=\"1\"></div><script src=\"/foo\"></script><div id=\"2\"><img><img></div><a id=\"3\"></a><i></i><foo /><foo>One</foo> <hr> hr text <hr> hr text two", TextUtil.stripNewlines(doc.getBody().html()));
    }
    ...
    public void handlesSolidusAtAttributeEnd() {
        ...
        DocumentImpl doc = Jsoup.parse(h);
        assertEquals("<a href=\"/\">link</a>", doc.getBody().html());
    }
    ...
    public void handlesMultiClosingBody() {
        ...
        assertEquals(3, doc.getBody().getChildren().size());
    }
    ...
    public void handlesBlocksInDefinitions() {
        ...
        assertEquals("<dl><dt><div id=\"1\">Term</div></dt><dd><div id=\"2\">Def</div></dd></dl>", TextUtil.stripNewlines(doc.getBody().html()));
    }
    ...
    public void handlesBaseWithoutHref() {
        ...
        DocumentImpl doc = Jsoup.parse(h, "http://example.com/");
        ElementImpl a = doc.select("a").first();
    ...
    public void normalisesHeadlessBody() {
        DocumentImpl doc = Jsoup.parse("<html><body><span class=\"foo\">bar</span>");
    ...
    public void normalisedBodyAfterContent() {
        DocumentImpl doc = Jsoup.parse("<font face=Arial><body class=name><div>One</div></body></font>");
    ...
    public void testHgroup() {
        ...
        DocumentImpl doc = Jsoup.parse("<h1>Hello <h2>There <hgroup><h1>Another<h2>headline</hgroup> <hgroup><h1>More</h1><p>stuff</p></hgroup>");
        assertEquals("<h1>Hello </h1><h2>There <hgroup><h1>Another</h1><h2>headline</h2></hgroup> <hgroup><h1>More</h1><p>stuff</p></hgroup></h2>", TextUtil.stripNewlines(doc.getBody().html()));
    }

    @Test
    public void testRelaxedTags() {
        DocumentImpl doc = Jsoup.parse("<abc_def id=1>Hello</abc_def> <abc-def>There</abc-def>");
        assertEquals("<abc_def id=\"1\">Hello</abc_def> <abc-def>There</abc-def>", TextUtil.stripNewlines(doc.getBody().html()));
    }
    ...
    public void testHeaderContents() {
        ...
        DocumentImpl doc = Jsoup.parse("<h1>Hello <div>There</div> now</h1> <h2>More <h3>Content</h3></h2>");
        assertEquals("<h1>Hello <div>There</div> now</h1> <h2>More </h2><h3>Content</h3>", TextUtil.stripNewlines(doc.getBody().html()));
    }
    ...
    public void testSpanContents() {
        ...
        DocumentImpl doc = Jsoup.parse("<span>Hello <div>there</div> <span>now</span></span>");
        assertEquals("<span>Hello <div>there</div> <span>now</span></span>", TextUtil.stripNewlines(doc.getBody().html()));
    }

    @Test
    public void testNoImagesInNoScriptInHead() {
        // jsoup used to allow, but against spec if parsing with noscript
        DocumentImpl doc = Jsoup.parse("<html><head><noscript><img src='foo'></noscript></head><body><p>Hello</p></body></html>");
    ...
    public void testAFlowContents() {
        ...
        DocumentImpl doc = Jsoup.parse("<a>Hello <div>there</div> <span>now</span></a>");
        assertEquals("<a>Hello <div>there</div> <span>now</span></a>", TextUtil.stripNewlines(doc.getBody().html()));
    }

    @Test
    public void testFontFlowContents() {
        // html5 has no definition of <font>; often used as flow
        DocumentImpl doc = Jsoup.parse("<font>Hello <div>there</div> <span>now</span></font>");
        assertEquals("<font>Hello <div>there</div> <span>now</span></font>", TextUtil.stripNewlines(doc.getBody().html()));
    }
    ...
    public void handlesMisnestedTagsBI() {
        ...
        DocumentImpl doc = Jsoup.parse(h);
        assertEquals("<p>1<b>2<i>3</i></b><i>4</i>5</p>", doc.getBody().html());
    ...
    public void handlesMisnestedAInDivs() {
        ...
        assertEquals(
                ...
                StringUtil.normaliseWhitespace(doc.getBody().html()));
    }
    ...
    public void handlesUnexpectedMarkupInTables() {
        ...
        DocumentImpl doc = Jsoup.parse(h);
        assertEquals("<b></b><b>bbb</b><table><tbody><tr><td>aaa</td></tr></tbody></table><b>ccc</b>", TextUtil.stripNewlines(doc.getBody().html()));
    }
    ...
    public void handlesUnclosedAnchors() {
        ...
        assertEquals(want, doc.getBody().html());
    }
    ...
    public void handlesSpanInTbody() {
        ...
        DocumentImpl doc = Jsoup.parse(h);
        assertEquals(doc.select("span").first().getChildren().size(), 0); // the span gets closed
        assertEquals(doc.select("table").size(), 1); // only one table
    }

    @Test
    public void handlesUnclosedTitleAtEof() {
        assertEquals("Data", Jsoup.parse("<title>Data").getTitle());
        assertEquals("Data<", Jsoup.parse("<title>Data<").getTitle());
        assertEquals("Data</", Jsoup.parse("<title>Data</").getTitle());
        assertEquals("Data</t", Jsoup.parse("<title>Data</t").getTitle());
        assertEquals("Data</ti", Jsoup.parse("<title>Data</ti").getTitle());
        assertEquals("Data", Jsoup.parse("<title>Data</title>").getTitle());
        assertEquals("Data", Jsoup.parse("<title>Data</title >").getTitle());
    }
    ...
    public void noImplicitFormForTextAreas() {
        ...
        DocumentImpl doc = Jsoup.parse("<textarea>One</textarea>");
        assertEquals("<textarea>One</textarea>", doc.getBody().html());
    }

    @Test
    public void handlesEscapedScript() {
        DocumentImpl doc = Jsoup.parse("<script><!-- one <script>Blah</script> --></script>");
        assertEquals("<!-- one <script>Blah</script> -->", doc.select("script").first().data());
    }

    @Test
    public void handles0CharacterAsText() {
        DocumentImpl doc = Jsoup.parse("0<p>0</p>");
        assertEquals("0\n<p>0</p>", doc.getBody().html());
    }

    @Test
    public void handlesNullInData() {
        DocumentImpl doc = Jsoup.parse("<p id=\u0000>Blah \u0000</p>");
        assertEquals("<p id=\"\uFFFD\">Blah \u0000</p>", doc.getBody().html()); // replaced in attr, NOT replaced in data
    }
    ...
    public void handlesNewlinesAndWhitespaceInTag() {
        DocumentImpl doc = Jsoup.parse("<a \n href=\"one\" \r\n id=\"two\" \f >");
        assertEquals("<a href=\"one\" id=\"two\"></a>", doc.getBody().html());
    }
    ...
    public void tracksErrorsWhenRequested() {
        ...
        DocumentImpl doc = Jsoup.parse(html, "http://example.com", parser);
    ...
    public void tracksLimitedErrorsWhenRequested() {
        ...
        DocumentImpl doc = parser.parseInput(html, "http://example.com");
    ...
    public void handlesCommentsInTable() {
        ...
        DocumentImpl node = Jsoup.parseBodyFragment(html);
    ...
    public void handlesQuotesInCommentsInScripts() {
        ...
        assertEquals("<script>\n" +
                ...
                "    document.write('</scr' + 'ipt>');\n" +
                "  // -->\n" +
                "</script>", node.getBody().html());
    }

    @Test
    public void handleNullContextInParseFragment() {
        String html = "<ol><li>One</li></ol><p>Two</p>";
        List<NodeImpl> nodes = Parser.parseFragment(html, null, "http://example.com/");
    ...
    public void doesNotFindShortestMatchingEntity() {
        ...
        DocumentImpl doc = Jsoup.parse(html);
        assertEquals(StringUtil.normaliseWhitespace("One &amp;clubsuite; ♣"), doc.getBody().html());
    }
    ...
    public void relaxedBaseEntityMatchAndStrictExtendedMatch() {
        ...
        assertEquals("&amp; \" &reg; &amp;icy &amp;hopf &icy; &hopf;", doc.getBody().html());
    }
    ...
    public void handlesTagsInTextarea() {
        ...
        DocumentImpl doc = Jsoup.parse(html);
        assertEquals("<textarea>&lt;p&gt;Jsoup&lt;/p&gt;</textarea>", doc.getBody().html());
    }
    ...
    public void createsFormElements() {
        ...
        DocumentImpl doc = Jsoup.parse(html);
        ElementImpl el = doc.select("form").first();
    ...
    public void convertsImageToImg() {
        ...
        DocumentImpl doc = Jsoup.parse(h);
        assertEquals("<img>\n<svg>\n <image />\n</svg>", doc.getBody().html());
    }

    @Test
    public void handlesInvalidDoctypes() {
        // would previously throw invalid name exception on empty doctype
        DocumentImpl doc = Jsoup.parse("<!DOCTYPE>");
        assertEquals(
    ...
    public void handlesManyChildren() {
        ...
        DocumentImpl doc = Parser.parseBodyFragment(longBody.toString(), "");

        // Assert
        assertEquals(50000, doc.getBody().childNodeSize());
    ...
    public void handlesDeepStack() {
        ...
        // Assert
        assertEquals(2, doc.getBody().childNodeSize());
    ...
    public void testNormalisesIsIndex() {
        DocumentImpl doc = Jsoup.parse("<body><isindex action='/submit'></body>");
    ...
    public void testReinsertionModeForThCelss() {
        ...
        DocumentImpl doc = Jsoup.parse(body);
        assertEquals(1, doc.getBody().getChildren().size());
    }
    ...
    public void testFragment() {
        ...
        DocumentImpl body = Jsoup.parseBodyFragment(html);
        assertEquals("<script type=\"text/javascript\">console.log('foo');</script> \n" +
                "<div id=\"somecontent\">\n" +
                " some content\n" +
                "</div> \n" +
                "<script type=\"text/javascript\">console.log('bar');</script>", body.getBody().html());
    }
    ...
    public void testHtmlLowerCase() {
        ...
        ElementImpl div = doc.selectFirst("#1");
    ...
    public void canPreserveTagCase() {
        ...
        DocumentImpl doc = parser.parseInput("<div id=1><SPAN ID=2>", "");
    ...
    public void handlesControlCodeInAttributeName() {
        DocumentImpl doc = Jsoup.parse("<p><a \06=foo>One</a><a/\06=bar><a foo\06=bar>Two</a></p>");
        assertEquals("<p><a>One</a><a></a><a foo=\"bar\">Two</a></p>", doc.getBody().html());
    }
    ...
    public void caseSensitiveParseTree() {
        ...
        DocumentImpl doc = parser.parseInput(html, "");
        assertEquals("<r> <X> A </X> <y> B </y> </r>", StringUtil.normaliseWhitespace(doc.getBody().html()));
    }
    ...
    public void normalizesDiscordantTags() {
        DocumentImpl document = Jsoup.parse("<div>test</DIV><p></p>");
        assertEquals("<div>\n test\n</div>\n<p></p>", document.getBody().html());
    }
    ...
    public void testTemplateInsideTable() throws IOException {
        ...
        Elements templates = doc.getBody().getElementsByTag("template");
        for (ElementImpl template : templates) {
            assertTrue(template.getChildNodes().size() > 1);
        }
    }
    ...
    public void testHandlesDeepSpans() {
        ...
        DocumentImpl doc = Jsoup.parse(sb.toString());
    ...
    public void commentAtEnd() throws Exception {
        DocumentImpl doc = Jsoup.parse("<!");
        assertTrue(doc.childNode(0) instanceof CommentImpl);
    }

    @Test
    public void preSkipsFirstNewline() {
        DocumentImpl doc = Jsoup.parse("<pre>\n\nOne\nTwo\n</pre>");
        ElementImpl pre = doc.selectFirst("pre");
        assertEquals("One\nTwo", pre.text());
        assertEquals("\nOne\nTwo\n", pre.wholeText());
    }
    ...
    public void handlesXmlDeclAndCommentsBeforeDoctype() throws IOException {
        ...
        assertEquals("A Certain Kind of Test", doc.getHead().select("title").text());
    }
    ...
    public void fallbackToUtfIfCantEncode() throws IOException {
        ...
        DocumentImpl doc = Jsoup.parse(new ByteArrayInputStream(in.getBytes()), null, "");
