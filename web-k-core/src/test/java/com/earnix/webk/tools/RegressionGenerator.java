...
import com.earnix.webk.swing.BoxRenderer;
import com.earnix.webk.swing.Java2DRenderer;
 ...
 * <pre>
 * com.earnix.webk.test.Regress ./regress/input-html/ ./regress/output.zip
 * </pre>
 */
@Slf4j
public class RegressionGenerator {
    ...
    public static void main(String[] args) throws Exception {
        ...
        final File outputDir = new File("tests/regress/snapshots/1.0");
        outputDir.mkdirs();
